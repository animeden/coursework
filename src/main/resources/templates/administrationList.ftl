...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/administration/sort" || f == "https://animedenapp.herokuapp.com/web/administration/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/administration/get/list" || f == "https://animedenapp.herokuapp.com/web/administration/get/list")
        {
            document.getElementById("sr").style.display = 'flex';
            document.getElementById("nsr").style.display = 'none';
        }
        if(f == "http://localhost:1821/web/administration/sort" || f == "http://localhost:1821/web/administration/get/list")
        {
