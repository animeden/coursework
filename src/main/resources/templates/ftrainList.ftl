...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/ftrain/sort" || f == "https://animedenapp.herokuapp.com/web/ftrain/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/ftrain/get/list" || f == "https://animedenapp.herokuapp.com/web/ftrain/get/list")
        {
            document.getElementById("sr").style.display = 'flex';
            document.getElementById("nsr").style.display = 'none';
        }
        if(f == "http://localhost:1821/web/ftrain/sort" || f == "http://localhost:1821/web/ftrain/get/list")
        {
            document.getElementById("mp1").style.display = 'flex';
            document.getElementById("mp2").style.display = 'none';
        }
        if(f == "https://animedenapp.herokuapp.com/web/ftrain/sort" || f == "https://animedenapp.herokuapp.com/web/ftrain/get/list")
        {
