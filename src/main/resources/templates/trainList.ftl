...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/ptrain/sort" || f == "https://animedenapp.herokuapp.com/web/ptrain/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/ptrain/get/list" || f == "https://animedenapp.herokuapp.com/web/ptrain/get/list")
        {
            document.getElementById("sr").style.display = 'flex';
            document.getElementById("nsr").style.display = 'none';
        }
        if(f == "http://localhost:1821/web/ptrain/sort" || f == "http://localhost:1821/web/ptrain/get/list")
        {
            document.getElementById("mp1").style.display = 'flex';
            document.getElementById("mp2").style.display = 'none';
        }
        if(f == "https://animedenapp.herokuapp.com/web/ptrain/sort" || f == "https://animedenapp.herokuapp.com/web/ptrain/get/list")
        {
