        ...
        <div style="display: flex">
            ...
            <div style="width: 10%; height: 159px; position: fixed; display: flex; flex-direction: column; justify-content: space-around; align-items: flex-start">
                ...
                <div style="height: 35px; background: deeppink; width: 70px; display: flex; justify-content: center; align-items: center; border-top-right-radius: 20px; border-bottom-right-radius: 20px" id="sr" onclick="fup()">
                    <a class="pl-3 pt-1" href="/web/passenger/sort" style="color: black; text-decoration: none; display: block; height: 100%; width: 100%">Sort</a>
                </div>
            ...
            <table border="3", bgcolor="#d10000", class="table table-dark">
                ...
                <#list passengers as passenger>
                    ...
                    <tr style="background: white; color: black">
                        ...
                        <td><a href="/web/passenger/delete/${passenger.id}" style="color: white"><button class="btn" style="background: #d60202; color: white">Delete</button></a></td>
...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/passenger/sort" || f == "https://animedenapp.herokuapp.com/web/passenger/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/passenger/get/list" || f == "https://animedenapp.herokuapp.com/passenger/get/list")
        {
            document.getElementById("sr").style.display = 'flex';
            document.getElementById("nsr").style.display = 'none';
        }
        if(f == "http://localhost:1821/web/passenger/sort" || f == "http://localhost:1821/web/passenger/get/list")
        {
            document.getElementById("mp1").style.display = 'flex';
            document.getElementById("mp2").style.display = 'none';
        }
        if(f == "https://animedenapp.herokuapp.com/web/passenger/sort" || f == "https://animedenapp.herokuapp.com/web/passenger/get/list")
        {
